...
//    self.navigationItem.leftBarButtonItem=[[[UIBarButtonItem alloc]initWithTitle:@"登录" style:UIBarButtonItemStylePlain target:self action:@selector(showSigninViewController:)] autorelease];
    UIBarButtonItem* barButtonSubscribe=[[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemAdd target:self action:@selector(gotoRosterNewViewController:)] ;
    UIBarButtonItem* barButtonOrganize=[[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemOrganize target:self action:@selector(onButtonOrganize:)] ;
...
-(void)onTitleButton:(UIButton*)sender{
    NSLog(@"title button");
    ProfileViewController* rosterStatusViewController=[[ProfileViewController alloc]initWithStyle:UITableViewStyleGrouped];
...
-(void)showSigninViewController:(UIButton*)sender{
    if (![DRRRManager sharedManager].online){
        ...
        UINavigationController* navigation=[[UINavigationController alloc]initWithRootViewController:signinViewController];
        [self presentViewController:navigation animated:YES completion:^{
...
-(void)gotoRosterNewViewController:(UIButton*)sender{
    RosterNewViewController* rosterNewViewController=[[RosterNewViewController alloc]init];
    UINavigationController* navigationViewController=[[UINavigationController alloc]initWithRootViewController:rosterNewViewController];
...
-(void)gotoReceiveSubscribe:(DRRRRosterMember*)member{
    ...
    UIAlertView* alert=[[UIAlertView alloc]initWithTitle:@"接收关注" message:message delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"接收",@"拒绝", nil];
