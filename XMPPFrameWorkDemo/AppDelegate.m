...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController* navigationRoster=[[UINavigationController alloc]initWithRootViewController:rosterViewController] ;
    ...
    UINavigationController* navigationChatRoom=[[UINavigationController alloc]initWithRootViewController:chatRoomViewController];
    ...
    UINavigationController* navigationProfile=[[UINavigationController alloc]initWithRootViewController:profileViewController];
    ...
    RootTabViewController* rootController=[[RootTabViewController alloc]init];
